...
\cofoot{
\fontsize{10}{16}\selectfont % Letter spacing and font size

\textls[150]{Melbourne {\large\textperiodcentered} Victoria {\large\textperiodcentered} Australia}\\ % Your mailing address
{\Large\Letter} \textls[150]{\href{mailto:adairasilvan@gmail.com}{adairasilvan [at] gmail [dot] com} \ {\Large\Info} \href{https://adairneto.github.io/}{adairneto.github.io}} % Your email address and phone number
}
...
{\fontsize{22}{22}\selectfont\scshape\textls[200]{Adair Antonio da Silva Neto}} % Your name at the top, was 28

\vspace{0.5cm} % Extra whitespace after the large name at the top, was 1.5cm
...
\begin{tabularx}{0.97\linewidth}{>{\raggedleft\scshape}p{2cm}X}
\gray Period & \textbf{August 2025 --- December 2025}\\
\gray Employer & \textbf{Mathematics and Statistics Learning Centre} \hfill Melbourne, Australia\\
\gray Job Title & \textbf{Tutor (Teaching Assistant): Advanced Probability (Master's Level)}
       % \\ & Syllabus: Measure and Integral. Lebesgue Integral on $\mathbf{R}^n$. Measurable sets. Monotone Convergence Theorem. Dominated Convergence Theorem. Convergence in measure. $L^p$ spaces. Egorov's Theorem. Radon-Nikodym Theorem. Riesz Representation Theorem. Fubini theorem.
\end{tabularx}
...
\gray Job Title & \textbf{Teaching Assistant: Real Analysis (Measure Theory)}
       % \\ & Syllabus: Measure and Integral. Lebesgue Integral on $\mathbf{R}^n$. Measurable sets. Monotone Convergence Theorem. Dominated Convergence Theorem. Convergence in measure. $L^p$ spaces. Egorov's Theorem. Radon-Nikodym Theorem. Riesz Representation Theorem. Fubini theorem.
\end{tabularx}
...
\gray Job Title & \textbf{Undergraduate Researcher}\\
       & Research Title: \href{https://github.com/adairneto/Malliavin-Calculus}{Malliavin Calculus with Applications to Finance}
\end{tabularx}
...
\gray Employer & \textbf{São Paulo Research Foundation, FAPESP} \hfill Campinas, Brazil\\
\gray Job Title & \textbf{Undergraduate Researcher}\\
       & Research Title: \href{https://github.com/adairneto/Stochastic-Differential-Equations}{An Introduction to Stochastic Differential Equations}
\end{tabularx}
